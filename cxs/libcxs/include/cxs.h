...
cxs_error_t cxs_issuer_create_claim(cxs_command_handle_t, const char *source_id, cxs_schema_seq_no_t schema_seq_no, const char *issuer_did, const char * claim_data, void (*cb)(cxs_command_handle_t command_handle, cxs_error_t err, cxs_claim_handle_t claim_handle));

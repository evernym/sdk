...
#[no_mangle]
pub extern fn cxs_claimdef_update_state(command_handle: u32,
                                        claimdef_handle: u32,
    ...
    thread::spawn(move|| {
        claim_def::update_state(claimdef_handle);

        cb(command_handle, error::SUCCESS.code_num, claim_def::get_state(claimdef_handle));
    });
...
mod tests {
    ...
    extern "C" fn deserialize_cb(command_handle: u32, err: u32, claimdef_handle: u32) {
        ...
        let expected = "{\"claim_def\":{\"ref\":15,\"origin\":\"4fUDR9R7fjwELRvH9JT6HH\",\"signature_type\":\"CL\",\"data\":{\"primary\":{\"n\":\"9\",\"s\":\"5\",\"rms\":\"4\",\"r\":{\"zip\":\"1\",\"address1\":\"7\",\"address2\":\"8\",\"city\":\"6\",\"state\":\"6\"},\"rctxt\":\"7\",\"z\":\"7\"},\"revocation\":null}},\"handle\":1378455216,\"name\":\"NAME\",\"source_id\":\"test id\",\"state\":2}";

...
describe('A Proof', function () {
  ...
  it.only('get proof has an invalid proof state with incorrect proof', async () => {
    ...
    assert.equal(JSON.stringify(proofData), '[{"schema_seq_no":15,"issuer_did":"4fUDR9R7fjwELRvH9JT6HH","claim_uuid":"claim::f22cc7c8-924f-4541-aeff-29a9aed9c46b","name":"state","value":"UT","type":"revealed"}]')
  })
})

...
class IssuerCredential(VcxStateful):
    ...
    def __init__(self, source_id: str, attrs: dict, cred_def_id: str, name: str):
    ...
    @staticmethod
    async def create(source_id: str, attrs: dict, cred_def_id: str, name: str):
        attrs = {k: [v] for k, v in attrs.items()}
        constructor_params = (source_id, attrs, cred_def_id, name)
        ...
        c_params = (c_source_id, c_cred_def_id, c_issuer_did, c_data, c_name)

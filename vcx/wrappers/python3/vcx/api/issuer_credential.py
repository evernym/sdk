...
class IssuerCredential(VcxStateful):
    ...
    def __init__(self, source_id: str, attrs: dict, schema_no: int, name: str, price: float):
    ...
    @staticmethod
    async def create(source_id: str, attrs: dict, schema_no: int, name: str, price: float):
        attrs = {k: [v] for k, v in attrs.items()}
        constructor_params = (source_id, attrs, schema_no, name, price)
        ...
        c_params = (c_source_id, c_schema_no, c_issuer_did, c_data, c_name, c_price)

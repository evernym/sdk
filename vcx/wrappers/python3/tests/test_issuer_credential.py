...
async def test_create_issuer_credential():
    issuer_credential = await IssuerCredential.create(source_id, attrs, schema_no, name, price)
...
async def test_serialize_with_bad_handle():
    with pytest.raises(VcxError) as e:
        issuer_credential = IssuerCredential(source_id, attrs, schema_no, name, price)

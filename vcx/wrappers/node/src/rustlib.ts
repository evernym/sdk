...
export interface IFFIEntryPoint {
  ...
  vcx_version: () => string,
  vcx_wallet_get_balance: (commandId: number, payment: number, cb: any) => number,
  ...
  vcx_credentialdef_create: (commandId: number, sourceId: string, credentialDefName: string, schemaNo: number,
                             issuerDid: string, revocation: boolean, payment: number, cb: any) => number
...
export const FFIConfiguration: { [ Key in keyof IFFIEntryPoint ]: any } = {
  ...
  vcx_wallet_get_balance: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_PAYMENT_HANDLE, FFI_CALLBACK_PTR]],
  ...
  vcx_issuer_create_credential: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_SOURCE_ID,
    'int', 'string', 'string', 'string', 'double', 'pointer']],
  ...
  vcx_credentialdef_create: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_SOURCE_ID, FFI_STRING_DATA, FFI_SCHEMA_NUMBER,
    FFI_STRING_DATA, FFI_BOOL, FFI_PAYMENT_HANDLE, FFI_CALLBACK_PTR]],

...
export interface IFFIEntryPoint {
  ...
  vcx_credential_submit_payment: (commandId: number, handle: string, cb: any) => number,
...
export const FFIConfiguration: { [ Key in keyof IFFIEntryPoint ]: any } = {
  ...
  vcx_credential_submit_payment: [FFI_ERROR_CODE, [FFI_COMMAND_HANDLE, FFI_CREDENTIAL_HANDLE, FFI_CALLBACK_PTR]],

...
pub static DID_ALREADY_EXISTS_IN_WALLET: Error = Error { code_num: 1082, message: "Attempted to add a DID to wallet when that DID already exists in wallet" };
pub static DUPLICATE_MASTER_SECRET: Error = Error { code_num: 1083, message: "Attempted to add a Master Secret that already existed in wallet"};

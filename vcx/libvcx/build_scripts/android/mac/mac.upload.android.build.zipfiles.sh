...
cp ./libvcxall_${DATETIME}_arm.zip  /usr/local/var/www/download/android
...
cp ./libvcxall_${DATETIME}_arm64.zip  /usr/local/var/www/download/android
...
cp ./libvcxall_${DATETIME}_armv7.zip  /usr/local/var/www/download/android
...
cp ./libvcxall_${DATETIME}_x86.zip  /usr/local/var/www/download/android
...
cp ./libvcxall_${DATETIME}_x86-64.zip  /usr/local/var/www/download/android

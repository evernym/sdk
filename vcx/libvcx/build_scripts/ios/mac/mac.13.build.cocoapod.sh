...
xcodebuild test -project vcx.xcodeproj -scheme vcx -destination 'platform=iOS Simulator,name=iPhone xs,OS=12.0' -configuration Debug CONFIGURATION_BUILD_DIR=. clean

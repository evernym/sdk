...
xcodebuild test -project vcx.xcodeproj -scheme vcxTests -configuration Debug CONFIGURATION_BUILD_DIR=. clean -destination 'platform=iOS Simulator,name=iPhone xs,OS=12.0'

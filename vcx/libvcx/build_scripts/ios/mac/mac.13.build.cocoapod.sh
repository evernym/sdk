...
xcodebuild test -project vcx.xcodeproj -scheme vcxTests -destination 'platform=iOS Simulator,name=iPhone x,OS=12.0' -configuration Debug CONFIGURATION_BUILD_DIR=. clean

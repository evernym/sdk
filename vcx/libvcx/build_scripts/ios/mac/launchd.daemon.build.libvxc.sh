...
./mac.03.libindy.build.sh debuginfo "${IOS_TARGETS}" noclean > ./mac.03.libindy.build.sh.out 2>&1
./mac.04.libvcx.setup.sh > ./mac.04.libvcx.setup.sh.out 2>&1
./mac.06.libvcx.build.sh debuginfo "${IOS_TARGETS}" noclean > ./mac.06.libvcx.build.sh.out 2>&1
